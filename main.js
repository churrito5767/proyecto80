...
{
    ver_alumno_array.push("<h4>NOMBRE _ " + nombre_alumno_array[k] + "</h4>");
...
document.getElementById("mostrar_nombre_sin_comas");
...
function sorting()
{
    ...
    for (var k = 0; k < longitud_nombre_alumnos_array; k++)
    {
        ver_alumno_array_ordenar.push("<h4>NOMBRE _ " + nombre_alumno_array[k] + "</h4>");
